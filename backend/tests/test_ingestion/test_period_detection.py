...
class TestFilenameDetection:
    ...
    def test_detect_yyyy_yy_hyphen(self):
        ...
        assert result.academic_label == "2026"
    ...
    def test_detect_future_year(self):
        ...
        assert result.academic_label == "2028"
...
class TestLabelUtilities:
    ...
    def test_build_label(self):
        assert build_period_label(2025, 2026) == "2026"
        assert build_period_label(2022, 2023) == "2023"
