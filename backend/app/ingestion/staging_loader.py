...
class CsvToStagingStream(io.TextIOBase):
    ...
    """
    def __init__(self, file_path: str, dataset_id: str, chunk_size: int = 50000):
...
def load_to_staging(
    ...
    if extension == ".csv":
        stream_buf = CsvToStagingStream(file_path, dataset_id_str, chunk_size=50000)
        ...
        total_rows = stream_buf.row_counter - 1
        stream_buf.close()
        return total_rows
