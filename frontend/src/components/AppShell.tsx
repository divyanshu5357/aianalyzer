  ...
  return (
    <div className={`flex h-screen overflow-hidden font-sans transition-colors duration-200 ${isDark ? "bg-[#0B0F19] text-slate-100" : "bg-slate-50 text-slate-900"}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto overflow-x-hidden">
        ...
        <header className={`px-4 py-2.5 border-b flex flex-wrap xl:flex-nowrap items-center justify-between gap-2.5 relative z-10 shrink-0 ${isDark ? "bg-[#0E1322] border-[#1E293B]" : "bg-white border-slate-200"}`}>
            ...
            <div>
              ...
              {activeDataset ? (
                <div className="flex items-center gap-1.5 text-[10px] text-slate-400 font-medium mt-0.5">
                  ...
                  <span className={`truncate max-w-[160px] font-semibold ${isDark ? "text-slate-300" : "text-slate-700"}`}>
          ...
          <div className="flex items-center gap-1.5 flex-wrap sm:flex-nowrap shrink-0">
            ...
            <div className="relative">
              <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-xl border transition-all ${
                ...
                <select
                  ...
                  className="bg-transparent text-xs font-bold focus:outline-none cursor-pointer pr-3 appearance-none"
                >
                ...
                <ChevronRight className="w-3 h-3 rotate-90 text-slate-400 pointer-events-none -ml-2" />
              </div>
            </div>
            ...
            <div className="relative flex items-center">
              ...
              >
                ...
                <button
                  ...
                  className="px-2 py-0.5 text-[11px] font-bold rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white shadow-xs transition-all cursor-pointer flex items-center gap-0.5 active:scale-95 shrink-0"
                ...
                {(appliedFromDate || appliedToDate) && (
                  <button
                    ...
                    className="p-0.5 text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors cursor-pointer shrink-0"
            ...
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isLoadingDataset ? "animate-spin text-indigo-500" : ""}`} />
            </button>
